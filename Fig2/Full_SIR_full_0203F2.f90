...
!							15) background deacetylation of methyl & acetyl
	...
	open (unit=9,status="old", file="stats_old.dat", action="write")
	do numnuc=1,6
		distSil=8+4*numnuc !In tetramers, not octamers.
		L=distSil
	...
	KKd=0.52!0.52 wt and 0.3 for myc
	KKe=0.5
	KKi=0.5
	KKn=0.5
	...
	X=(/0,0,0,4+2*numnuc,0,0,4+2*numnuc,0/)
