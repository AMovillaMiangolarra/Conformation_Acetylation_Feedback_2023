...
set output 'trans_nucl_number.pdf'
...
'stats.dat' using 1:6 with linespoints lc 'black' lw 1.5 ps 2 lt 5 title 'Model'
...
'stats.dat' using 1:7 with linespoints lc 'black' lw 1.5 ps 2 lt 5 title 'Model'
